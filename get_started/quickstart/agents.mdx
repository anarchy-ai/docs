...
dynamic_params: a dictionary that contains key value pairs {parameter:description} of mutable parameters to the API endpoint that need to be set by REBEL to answer a query
