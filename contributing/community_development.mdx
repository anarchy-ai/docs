...
We know contributing can be daugnting, but we're here to help.  We want you to succeed. The first rule is be annoying, ask us for help, ask each other for help.

The first and most importantly step is to [join our discord](https://discord.com/channels/1075227138766147656/1147542772824408074) read the guidelines, and introduce yourself in the #intro channel.
...
OR 
* **To keep us creative**: post an oss project you built from github (doesn't have to be big) on top of anarchy in the [#personal-projects discord channel](https://discord.com/channels/1075227138766147656/1147579751511359541).
